...
my_widget_name  = "QFellesThermocouple"
my_widget_group = "QtFellesLabWidgets"
my_widget_module = "felleslab.qt_widgets.thermocouple"


class PyThermocouplePlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        """
        """
        super(PyThermocouplePlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        """
        return QFellesThermocouple(parent)

    def name(self):
        """
        Return the name of the custom widget class that is provided by this plugin
        """
    ...
    def icon(self):
        """ Return the icon used to represent the widget in the QtDesigner box
        """
    ...
    def domXml(self):
        """ Return XML description of the default values of the properties of
            the widget.
        """
