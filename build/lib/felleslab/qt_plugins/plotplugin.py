...
my_widget_icon  = ':/icons/plot/16x16_plot.png'
my_widget_name  = "QFellesPlot"
my_widget_group = "QtFellesLabWidgets"
my_widget_module = 'felleslab.qt_widgets.plot'

class PyPlotPlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        """
        """
        super(PyPlotPlugin, self).__init__(parent)
