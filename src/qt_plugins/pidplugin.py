...
from felleslab.qt_widgets.pid import QFellesPIDAlgorithm
from felleslab.icons import *

# Name of the Icon used for the widget
my_widget_icon  = ':/icons/instruments/16x16_thumbnail.png'
my_widget_name  = "QFellesPIDAlgorithm"
my_widget_group = "QtFellesLabWidgets"
my_widget_module = 'felleslab.qt_widgets.pid'

class PyPIDAlgorithmPlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        super(PyPIDAlgorithmPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        return QFellesPIDAlgorithm(parent)
