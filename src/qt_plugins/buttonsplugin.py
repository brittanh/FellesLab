...
my_widget_icon  = ':/icons/buttons/16x16_play.png'
my_widget_name  = "QFellesButtons"
my_widget_group = "QtFellesLabWidgets"
my_widget_module = 'felleslab.qt_widgets.buttons'
