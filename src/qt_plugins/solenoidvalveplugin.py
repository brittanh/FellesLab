...
my_widget_icon  = ':/icons/valves/16x16_thumbnail.png'
my_widget_name  = "QFellesSolenoidValve"
my_widget_group = "QtFellesLabWidgets"
my_widget_module = 'felleslab.qt_widgets.solenoidvalve'

class PySolenoidValvePlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        super(PySolenoidValvePlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        ...
        return QFellesSolenoidValve(parent)
